      ...
      <div className="grid gap-6">
        <Card>
          <CardHeader>
            ...
            <CardDescription>
              Professional recommendation and treatment guidance
            </CardDescription>
          </CardHeader>
              ...
              <div>
                ...
                <div className="flex items-center space-x-2">
                  <Badge variant="secondary">
                    {/* {advice.agronomist?.name || "Unknown"} */}
                  </Badge>
                </div>
              </div>
                    ...
                    {advice.medicine.usageInstructions.length > 0 && (
                      <div>
                        ...
                        <ol className="list-decimal list-inside text-sm space-y-1">
                          {advice.medicine.usageInstructions.map(
                            (instruction, index) => (
                  ...
                  <div className="bg-blue-50 dark:bg-blue-950/20 p-4 rounded-lg">
                    <div className="flex items-center justify-between mb-2">
                      <Badge variant="outline">
                        {advice.detection.disease?.name || "Unknown Disease"}
                      </Badge>
                      <Badge variant="secondary">
                        {Math.round(advice.detection.confidence * 100)}%
                        confidence
                      </Badge>
                    </div>
              ...
              <div className="space-y-2">
                <div className="flex justify-between">
                  ...
                  <span className="text-muted-foreground">
                    {/* {new Date(advice.updatedAt).toLocaleDateString()} */}
                  </span>
                </div>
                <div className="flex justify-between">
                  <span>Type:</span>
                  <span className="text-muted-foreground">
                    {/* {advice.detection ? "Detection-specific" : "General"} */}
                  </span>
                </div>
              </div>
            </CardContent>
